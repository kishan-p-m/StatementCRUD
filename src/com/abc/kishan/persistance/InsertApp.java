...
public class InsertApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("DriverManager Connection established sucessfully..." +url);
			if (connection!=null) {
				statement = connection.createStatement();
				}
			if (statement!=null) {
				 String sqlInsertQuery= "insert into student (sid,sname,sage,saddress) values(01,'Abhi',25,'BNG') ";
